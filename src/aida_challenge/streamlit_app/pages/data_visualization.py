...
with col2:
    ...
    # st.markdown(
    #    '<p class="main-header">S.T.R.A.T.E.G.Y. Dashboard</p>',
    #    unsafe_allow_html=True,
    # )
    st.markdown(
...
with tab0:
    ...
    def explore_dataframe(df, table_name):
        ...
        # Sample Data
        st.subheader("📄 Sample Data (Random 100 rows)")
        sample_size = min(100, len(df))
        st.dataframe(df.sample(sample_size), use_container_width=True, height=400)
